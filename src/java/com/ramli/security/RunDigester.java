...
/**
 * <p>
 * This Application is used to test the encryption done by the <code>Digester</code> <i>Class</i> by passing in a
 * <code>String</code> of characters into an input prompt and then retrieving the resulting digest through the
 * command line interface. The <code>Digester.getPassword</code> method is called in the main method of this <i>Class</i>
 * </p>
 *
 * @author      Jevison Archibong
 *
...
public class RunDigester
{
     ...
     * @deprecated      <font color="red">This method may be removed in the future
     * when a more convinient version of it's <i>Class</i> is developed.</font>
     */
