...
/**
 * <p>
 * This <i>Class</i> is used to encrypt user passwords through digestion cryptography according to the
 * JASYPT (JAva Simplified encrYPTion) standard API. <b>See <a href="http://www.jasypt.org">www.jasypt.org</a></b>
 * Classes and servlets that do sign-up processes must instantiate an instance of this <i>Class</i>
 * in order to encrypt/digest the user password before storing it in the database. Programmers are advised
 * to simply call the <code>doDigest</code> method of this class with the user's password as the single
 * <code>String</code> argument. The <code>doDigest</code> method will then take in the argument that was
 * passed in and perform a <i>one-way</i> encryption (called digestion) on it using the
 ...
 * <ol>
 * <li>The user requests for a sign-up form, fills the form including his/her choosen password and then submits
 * the form.</li>
 ...
 * <br>
 * <br>
 * <b>Note:</b> The <code>DigestMatcher.doMatch</code> method must be used to handle the user authentication
 * for login validation processes.
 * </p>
 * <p>
 * The <code>getPassword</code> method is an optional method, which may be useful in a Java console based
 * or GUI application/<i>Class</i> which must also instantiate an instance of this <i>Class</i>.
 * </p>
 * @author      Jevison Archibong
 *
 * @version     1.1
...
public final class Digester
{
    ...
    /**
     * This field is active in the optional <code>getPassword</code> method.
     * It is used to hold the specified password for digestion tests.
    ...
    /**
     * This method is strictly for the Java Developer in a development environment, be it a console
     * based or GUI application. It cannot be conviniently called by a <i>Servlet</i>, <i>Scriptlet</i>,
     * <i>Facelet</i>, <i>Applet</i> or any of the Java web form classes. Developers are advised not to use
     * this method except for testing purposes. Also, this method is highly associated with the <code>RunDigester
     * </code><i>Class.</i>
     *
