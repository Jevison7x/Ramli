...
/**
 * <p>
 * This <i>Class</i> is used during authentication to match a user's password with the user's encrypted password.
 * The <i>Class</i> does this by taking the encrypted password (also called digest) of the user (usually retrieved with a database query),
 * and then determines if this password is the same password that produced the retrieved digest. This process is called <i>Matching</i>
...
public final class DigestMatcher
{
     ...
     * <p>
     * This method should be called prior to the calling of the <code>doMatch</code> method, and the parameter
     * passed in should be the encrypted password of the user usually retrieved with a database query.
     * </p>
     ...
     * <li>The <code>StandardStringDigester.matches</code> method performs the matching process on the reverse
     * of the password+salt <code>String</code> concatenation with the true digest retrieved from the
     * <code>getDigest</code> method.
     * </li>
     * <li>The method returns <font color="green"><b><i>true</i></b></font> if the combination matches
     * else it returns <font color="red"><b><i>false</i></b></font>.
     * </li>
     * <ul>
     * </p>
     ...
     * @return              <font color="green"><b><i>true</i></b></font> if the password
     * matches the given digest, else it returns <font color="red"><b><i>false</i></b></font>.
     * @see                 Digester
     */
